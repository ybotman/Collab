#!/bin/bash
# INBOX script for Dash - simplified to avoid permission prompts
# Usage: bash ~/MyDocs/Gotan/scripts/inbox-dash.sh
...
echo "[LOCAL HANDOFFS]"
ls -lt ~/.claude/local/handoffs/dash/*.md 2>/dev/null | head -5

echo ""
echo "[GIT HANDOFFS]"
ls -lt /Users/tobybalsley/MyDocs/Collab/handoffs/dash/*.md 2>/dev/null | head -5
